...
export default function CashCashRecords() {
  return (
    <PageShell title="Cash/cash_records.php" sourcePath="templates/Cash/cash_records.php">
      <div className="space-y-6">
        <div className="template-frame">
          <div className="template-content space-y-6">
            <div>
              <p className="text-xs uppercase tracking-[0.2em] text-emerald-300/70">Cash</p>
              <h2 className="text-2xl font-semibold text-slate-900">Cash Records</h2>
