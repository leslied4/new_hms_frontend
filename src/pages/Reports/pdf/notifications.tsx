...
const sourcePath = 'templates/Reports/pdf/notifications.php';
const rawHtml = `
<!--main body-->
<div class="row">
	<div class="col-md-12">
...
export default function ReportsPdfNotificationsPage() {
  return (
    <PageShell title="Reports/pdf/notifications.php" sourcePath={sourcePath}>
