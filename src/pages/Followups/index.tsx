...
const sourcePath = 'templates/Followups/index.php';
const rawHtml = `
					...
					<div class="row">
						<div class="col-md-12">
							<div class="card  card-box">
								<div class="card-head">
									<header>Pending Follow Ups</header>
									<div class="tools">
...
export default function FollowupsIndexPage() {
  return (
    <PageShell title="Followups/index.php" sourcePath={sourcePath}>
