...
const sourcePath = 'templates/Followups/today.php';
const rawHtml = `
					...
					<div class="row">
						<div class="col-md-12">
							<div class="card  card-box">
								<div class="card-head">
									<header>Today's Follow Ups</header>
									<div class="tools">
								  ...
								  <div class="table-scrollable">
									<table class="table table-hover order-column full-width customDataTable">
										...
										<!-- php: foreach ($followUps as $patientFollowup): -->
											<!-- php: $patientVisit = $patientFollowup->patient_visit; -->
...
export default function FollowupsTodayPage() {
  return (
    <PageShell title="Followups/today.php" sourcePath={sourcePath}>
