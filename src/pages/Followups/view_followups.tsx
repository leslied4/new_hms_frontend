...
const sourcePath = 'templates/Followups/view_followups.php';
const rawHtml = `
								...
								<div class="borderBox light bordered col-md-12">
									<div class="borderBox-title tabbable-line">
										...
										<ul class="nav nav-tabs">
											<li class="nav-item">
												<a href="#borderBox_tab1" data-toggle="tab"> View </a>
											</li>
									...
									<div class="borderBox-body">
										<div class="tab-content">
											<div class="tab-pane active" id="borderBox_tab1">
												...
												<!-- php: = $this->Form->create($viewFollowups); -->
												<div class="form-body">
													<div class="form-group row">
															...
															<div class="col-md-8">
																<textarea name="description" id="description" class="form-control-textarea" rows="5" readonly><!-- php: =$viewFollowups->description --></textarea>
															</div>
														</div>
														<div class="form-group row">
															...
															<div class="col-md-5">
																<SearchableSelectField class="form-control input-height" name="department_id" id="department_id" value="<!-- php: =$viewFollowups->department->name -->" readonly>
														...
														<div class="form-group row">
															...
															<div class="col-md-5">
																<SearchableSelectField class="form-control input-height" name="user_id" id="user_id" value="<!-- php: =$viewFollowups->user->first_name -->" readonly >
														...
														<div class="form-group row">
															...
															<div class="col-md-5">
																<div class="input-group date form_date " data-date="" data-date-format="dd MM yyyy" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd">
																	<input class="form-control input-height" size="16" placeholder="" name = "date_of_visit" id = "date_of_visit" type="text" value ="<!-- php: =$viewFollowups->date_of_visit -->" readonly>
														...
														<div class="form-group row">
															...
															<div class="col-md-8">
																	<textarea name="comment"id="follcomment" placeholder="description" class="form-control-textarea" rows="5" readonly ><!-- php: =$viewFollowups->comment --></textarea>
																</div>
														</div>
														<div class="form-group row">
															...
															<div class="col-md-5">
																<SearchableSelectField class="form-control input-height" name="followupstatus_id" id="followupstatus_id" value="<!-- php: =$viewFollowups->followupstatus->name -->" readonly>
													...
													<div class="row">
														<div class="offset-md-4 col-md-8">
															<a href="<!-- php: =$this->Url->build(['controller'=>'Patients','action'=>'viewPatientProfile',$viewFollowups->patient_visit->patient_id, $viewFollowups->patient_visit_id]) -->"><button type="button" class="btn btn-default">Close</button></a>
														</div>
													</div>
												</div>
												<!-- php: = $this->Form->end(); -->
...
export default function FollowupsViewFollowupsPage() {
  return (
    <PageShell title="Followups/view_followups.php" sourcePath={sourcePath}>
