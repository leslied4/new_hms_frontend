...
const sourcePath = 'templates/Accounts/manage_accounts.php';
const rawHtml = `
...
<div class="card card-topline-<!-- php: = $theme1 -->" style="margin-bottom: 0px">
    <div class="card-body no-padding" style="padding-top: 5px; padding-bottom: 5px; ">
        <h3 style="margin: 0px;" class="setting-header">Manage Accounts</h3>
    </div>
</div>
    ...
    <div class="col-md-12 col-sm-12">
        <div class="panel tab-border card-box">
            <header class="panel-heading panel-heading-<!-- php: = $theme1 --> custom-tab " style="padding-bottom: 0px">
                ...
                <li class="nav-item top-caption active">
                    <a href="#statusProtocolsTab" class="" data-toggle="tab">
                        Status Protocols
                    </a>
                </li>
                <li class="nav-item top-caption">
                    <a href="#partnersTab" class="" data-toggle="tab">
                        Partners/Payers
                    </a>
                </li>
                <li class="nav-item top-caption">
                    <a href="#beneficiariesTab" class="" data-toggle="tab">
                        Beneficiaries
                    </a>
                </li>
                    <!-- <li class="nav-item top-caption">
            ...
            <div class="panel-body">
                <div class="tab-content">
                    <div class="tab-pane" id="statusProtocolsTab">
                        <!-- php: = $this->element('accounts/statusprotocols') -->
                    </div>
                    <div class="tab-pane" id="partnersTab">
                        <!-- php: = $this->element('accounts/partners') -->
                    </div>
                    <div class="tab-pane" id="beneficiariesTab">
                        <!-- php: = $this->element('accounts/beneficiaries') -->
                    </div>
                </div>
            </div>
...
export default function AccountsManageAccountsPage() {
  return (
    <PageShell title="Accounts/manage_accounts.php" sourcePath={sourcePath}>
