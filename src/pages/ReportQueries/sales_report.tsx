...
export default function ReportQueriesSalesReport() {
  return (
    <PageShell title="ReportQueries/sales_report.php" sourcePath="templates/ReportQueries/sales_report.php">
      <div className="space-y-6">
        <div className="template-frame">
          <div className="template-content space-y-6">
            <div>
              <p className="text-xs uppercase tracking-[0.2em] text-emerald-300/70">ReportQueries</p>
              <h2 className="text-2xl font-semibold text-slate-900">Sales Report</h2>
