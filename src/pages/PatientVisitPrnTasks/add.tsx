...
const sourcePath = 'templates/PatientVisitPrnTasks/add.php';
const rawHtml = `
...
<div class="patientVisitPrnTasks form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><!-- php: = __('Add Patient Visit Prn Task') --></legend>
...
export default function PatientVisitPrnTasksAddPage() {
  return (
    <PageShell title="PatientVisitPrnTasks/add.php" sourcePath={sourcePath}>
