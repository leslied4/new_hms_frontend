...
const sourcePath = 'templates/PatientVisits/patient_absconded_outcome.php';
const rawHtml = `
		...
		<div class="col-md-12 col-sm-12">
			<div class="card card-box">
                ...
                <!-- php: if ((sizeof($selectedVisit->patient_visit_admissions) > 0 && $admission_record->outcome_setter_id != null) || ((sizeof($selectedVisit->patient_visit_admissions) == 0))): -->
                    <!-- php: = $this->Form->create(null, ['url' => ['controller' => 'PatientVisits', 'action' => 'setAbscondedVisitOutcome'], 'class' => 'form-horizontal', 'id' => 'discharge_modal_form']) -->
                        <div class="form-body" id="discharge_modal_form_body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8  d-flex align-items-end">
                                    ...
                                    <input type="hidden" name="visit_outcome_id" value="5">
                            ...
                            <div class="form-group row">
                                <label class="control-label text-uppercase bold col-md-4">Reason :
                                </label>
                                <div class="col-md-8  d-flex align-items-end">
...
export default function PatientVisitsPatientAbscondedOutcomePage() {
  return (
    <PageShell title="PatientVisits/patient_absconded_outcome.php" sourcePath={sourcePath}>
