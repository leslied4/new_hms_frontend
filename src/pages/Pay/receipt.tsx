...
const sourcePath = 'templates/Pay/receipt.php';
const rawHtml = `
<!-- <html>
    <head>
...
<h3 class="text-center pb-4 pt-3" style="margin-bottom:0.5rem; margin-top:0; font-weight:500; line-height:1.2; font-size:1.75rem; padding-top:1rem; padding-bottom:1.5rem; text-align:center" align="center">
    <!-- php: = ($inst_name != null) ? $inst_name->institution : Cake\Core\Configure::read('FacilityName') --></h3>
...
<h6 class="my-0 mr-2" style="margin-bottom:0; margin-top:0; font-weight:500; line-height:1.2; font-size:1rem; margin-right:0.5rem">TRANSACTION DATE: </h6><!-- php: = date('Y-m-d') --></div>
        <div style="display:flex!important; align-items:center;margin-top:20px; white-space: nowrap;">
<h6 class="my-0 mr-2" style="margin-bottom:0; margin-top:0; font-weight:500; line-height:1.2; font-size:1rem; margin-right:0.5rem">TRANSACTION #: </h6> #LJL32</div>
        <div style="display:flex!important; align-items:center;margin-top:20px; white-space: nowrap;">
<h6 class="my-0 mr-2" style="margin-bottom:0; margin-top:0; font-weight:500; line-height:1.2; font-size:1rem; margin-right:0.5rem">PAYER NAME: </h6> 200.00</div>
        <div style="display:flex!important; align-items:center;margin-top:20px; white-space: nowrap;">
<h6 class="my-0 mr-2" style="margin-bottom:0; margin-top:0; font-weight:500; line-height:1.2; font-size:1rem; margin-right:0.5rem">AMOUNT: </h6> 200.00</div>
...
export default function PayReceiptPage() {
  return (
    <PageShell title="Pay/receipt.php" sourcePath={sourcePath}>
