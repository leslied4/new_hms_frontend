...
export default function QueueNurse() {
  return (
    <PageShell title="Queue/nurse.php" sourcePath="templates/Queue/nurse.php">
      <div className="space-y-6">
        <div className="template-frame">
          <div className="template-content space-y-6">
            <div>
              <p className="text-xs uppercase tracking-[0.2em] text-emerald-300/70">Queue</p>
              <h2 className="text-2xl font-semibold text-slate-900">Nurse</h2>
