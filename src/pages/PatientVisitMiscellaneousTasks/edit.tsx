...
const sourcePath = 'templates/PatientVisitMiscellaneousTasks/edit.php';
const rawHtml = `
...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><!-- php: = $this->Form->postLink( __('Delete'), ['action' => 'delete', $patientVisitMiscellaneousTask->id], ['confirm' => __('Are you sure you want to delete # {0}?', $patientVisitMiscellaneousTask->id)] ) --></li>
...
<div class="patientVisitMiscellaneousTasks form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><!-- php: = __('Edit Patient Visit Miscellaneous Task') --></legend>
...
export default function PatientVisitMiscellaneousTasksEditPage() {
  return (
    <PageShell title="PatientVisitMiscellaneousTasks/edit.php" sourcePath={sourcePath}>
