...
const sourcePath = 'templates/email/html/birthday.php';
const rawHtml = `
<!DOCTYPE html>
<html lang="en">
<head>
...
export default function EmailHtmlBirthdayPage() {
  return (
    <PageShell title="email/html/birthday.php" sourcePath={sourcePath}>
