...
const sourcePath = 'templates/email/html/default.php';
const rawHtml = `
...
export default function EmailHtmlDefaultPage() {
  return (
    <PageShell title="email/html/default.php" sourcePath={sourcePath}>
