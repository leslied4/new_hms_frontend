...
const sourcePath = 'templates/ImmunizationRequest/index.php';
const rawHtml = `
...
export default function ImmunizationRequestIndexPage() {
  return (
    <PageShell title="ImmunizationRequest/index.php" sourcePath={sourcePath}>
