...
export default function SettingsEditSetting() {
  ...
  const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    window.confirm('Update setting?');
  };

  return (
    <PageShell title="Settings/edit_setting.php" sourcePath="templates/Settings/edit_setting.php">
      <div className="space-y-6">
        <div className="template-frame">
          <div className="template-content space-y-6">
            <div>
              <p className="text-xs uppercase tracking-[0.2em] text-emerald-300/70">Settings</p>
              <h2 className="text-2xl font-semibold text-slate-900">Edit Setting</h2>
            </div>
