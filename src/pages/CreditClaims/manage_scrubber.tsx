...
const sourcePath = 'templates/CreditClaims/manage_scrubber.php';
const rawHtml = `
...
<div class="card card-topline-<!-- php: = $theme1 -->" style="margin-bottom: 0px">
	<div class="card-body no-padding" style="padding-top: 5px; padding-bottom: 5px; ">
		<h3 style="margin: 0px;" class="setting-header">Manage Scrubber</h3>
	</div>
</div>
		...
		<div class="panel tab-border card-box">
			<header class="panel-heading panel-heading-<!-- php: = $theme1 --> custom-tab " style="padding-bottom: 0px">
				<ul class="nav nav-tabs" style="margin-bottom: 0px;" id="manageVaccinesTabs" >				
					<li class="nav-item top-caption">
						<a href="#configTab" class="" data-toggle="tab">
			...
			<div class="panel-body">
				<div class="tab-content">
					...
					<!-- php: = $this->element('creditclaims/scrubber_config') -->
					</div>
...
export default function CreditClaimsManageScrubberPage() {
  return (
    <PageShell title="CreditClaims/manage_scrubber.php" sourcePath={sourcePath}>
