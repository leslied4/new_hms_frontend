...
const sourcePath = 'templates/PatientVisitMedicationTasks/edit.php';
const rawHtml = `
...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><!-- php: = $this->Form->postLink( __('Delete'), ['action' => 'delete', $patientVisitMedicationTask->id], ['confirm' => __('Are you sure you want to delete # {0}?', $patientVisitMedicationTask->id)] ) --></li>
...
<div class="patientVisitMedicationTasks form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><!-- php: = __('Edit Patient Visit Medication Task') --></legend>
...
export default function PatientVisitMedicationTasksEditPage() {
  return (
    <PageShell title="PatientVisitMedicationTasks/edit.php" sourcePath={sourcePath}>
