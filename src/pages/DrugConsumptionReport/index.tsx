...
const sourcePath = 'templates/DrugConsumptionReport/index.php';
const rawHtml = `
<!--main body-->
<div class="row">
	<div class="col-md-12">
		<div class="card  card-box">
		<!-- php: = $this->Form->create(null, ['type' => 'get','url'=>['controller'=>'DrugConsumptionReport','action'=>'index']]); -->
			<div class="d-flex flex-column">
				<div class="report-filter-form d-flex flex-wrap p-3">
					...
					<div class="d-flex flex-column mr-2">
						...
						<!-- php: = $this->Form->select('department', $departments, ['value' => $filters['department'], 'required'=>true, 'class'=>'form-control']); -->
					</div>
					<div class="d-flex flex-column mr-2">
						<label class="mb-0">Supplier</label>
						<!-- php: = $this->Form->select('supplier', $suppliers, ['value' => $filters['supplier'], 'required'=>true, 'class'=>'form-control']); -->
					</div>
					<div class="d-flex flex-column mr-2">
						<label class="mb-0">Status</label>
						<!-- php: = $this->Form->select('status', $statuses, ['value' => $filters['status'], 'required'=>true, 'class'=>'form-control']); -->
					</div>
					<!-- <div class="d-flex flex-column mr-2">
						<label class="mb-0">Period</label>
						<!-- php: = $this->Form->select('period', $periods, ['value' => $filters['period'], 'required'=>true, 'class'=>'form-control']); -->
					</div> -->
				</div>
...
export default function DrugConsumptionReportIndexPage() {
  return (
    <PageShell title="DrugConsumptionReport/index.php" sourcePath={sourcePath}>
