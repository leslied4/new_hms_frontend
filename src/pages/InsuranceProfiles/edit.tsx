...
const sourcePath = 'templates/InsuranceProfiles/edit.php';
const rawHtml = `
...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><!-- php: = $this->Form->postLink( __('Delete'), ['action' => 'delete', $insuranceProfile->id], ['confirm' => __('Are you sure you want to delete # {0}?', $insuranceProfile->id)] ) --></li>
...
<div class="insuranceProfiles form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><!-- php: = __('Edit Insurance Profile') --></legend>
...
export default function InsuranceProfilesEditPage() {
  return (
    <PageShell title="InsuranceProfiles/edit.php" sourcePath={sourcePath}>
