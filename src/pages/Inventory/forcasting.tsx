...
export default function InventoryForcasting() {
  return (
    <PageShell title="Inventory/forcasting.php" sourcePath="templates/Inventory/forcasting.php">
      <div className="space-y-6">
        <div className="template-frame">
          <div className="template-content space-y-6">
            <div>
              <p className="text-xs uppercase tracking-[0.2em] text-emerald-300/70">Inventory</p>
              <h2 className="text-2xl font-semibold text-slate-900">Forcasting</h2>
