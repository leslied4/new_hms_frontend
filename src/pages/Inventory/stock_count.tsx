...
export default function InventoryStockCount() {
  return (
    <PageShell title="Inventory/stock_count.php" sourcePath="templates/Inventory/stock_count.php">
      <div className="space-y-6">
        <div className="template-frame">
          <div className="template-content space-y-6">
            <div>
              <p className="text-xs uppercase tracking-[0.2em] text-emerald-300/70">Inventory</p>
              <h2 className="text-2xl font-semibold text-slate-900">Stock Count</h2>
