...
export default function InventoryEditItemModal() {
  return (
    <PageShell title="Inventory/edit_item_modal.php" sourcePath="templates/Inventory/edit_item_modal.php">
      <div className="space-y-6">
        <div className="template-frame">
          <div className="template-content space-y-6">
            <div>
              <p className="text-xs uppercase tracking-[0.2em] text-emerald-300/70">Inventory</p>
              <h2 className="text-2xl font-semibold text-slate-900">Edit Item Modal</h2>
