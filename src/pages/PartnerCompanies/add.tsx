...
const sourcePath = 'templates/PartnerCompanies/add.php';
const rawHtml = `
...
<div class="partnerCompanies form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><!-- php: = __('Add Partner Company') --></legend>
...
export default function PartnerCompaniesAddPage() {
  return (
    <PageShell title="PartnerCompanies/add.php" sourcePath={sourcePath}>
