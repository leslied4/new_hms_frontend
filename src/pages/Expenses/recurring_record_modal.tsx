...
export default function ExpensesRecurringRecordModal() {
  return (
    <PageShell title="Expenses/recurring_record_modal.php" sourcePath="templates/Expenses/recurring_record_modal.php">
      <div className="space-y-6">
        <div className="template-frame">
          <div className="template-content space-y-6">
            <div>
              <p className="text-xs uppercase tracking-[0.2em] text-emerald-300/70">Expenses</p>
              <h2 className="text-2xl font-semibold text-slate-900">Recurring Expense Record</h2>
