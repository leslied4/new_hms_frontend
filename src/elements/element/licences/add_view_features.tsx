...
<div class="row">
	<div class="borderBox light bordered col-md-12">
		<div class="borderBox-title tabbable-line">
			<div class="caption">
				<span class="caption-subject font-dark bold uppercase">System Features</span>
			</div>
			<ul class="nav nav-tabs">
				<li class="nav-item">
					<a href="#feature_add" data-toggle="tab"> Add </a>
				</li>
				<li class="nav-item">
					<a href="#features_view" data-toggle="tab"> View </a>
				</li>
			</ul>
		</div>
		<div class="borderBox-body">
			<div class="tab-content">
				<div class="tab-pane " id="feature_add">
					<h4>Add Feature</h4>
					<!-- php: = $this->Form->create(null, ['url' => ['controller' => 'Features', 'action' => 'add']]); -->
						<div class="form-group row">
							<label class="control-label col-md-4">Feature Name
				...
				<div class="tab-pane active" id="features_view">
									  ...
									  <div class="modal-dialog modal-dialog-centered" role="document">
										<div class="modal-content">
										  <div class="modal-header">
											<h4 class="modal-title" id="editProviderDialogueTitle">Edit Feature: <!-- php: = $value->name --></h4>
												...
												<div class="col-md-12 col-sm-12">
													<div class="card card-box">
														...
														<div class="card-body" id="bar-parent">
															<!-- php: = $this->Form->create($value, ['url' => ['controller' => 'Features', 'action' => 'edit', $value->id], 'class' => 'form-horizontal']) -->
																<div class="form-body">
																	<div class="form-group row">
...
export default function ElementElementLicencesAddViewFeatures() {
