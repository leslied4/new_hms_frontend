					...
					<div class="row">
						<div class="col-md-12">
							<div class="card card-topline-<!-- php: = $theme1 -->">
								<div class="card-head">
                                    <header>Submissions - Paid</header>
									<div class="tools">
										<!-- <a class="fa fa-repeat btn-color box-refresh" id="reset" href="javascript:;"></a>
										<a class="t-collapse btn-color fa fa-chevron-down" href="javascript:;"></a>
										<a class="t-close btn-color fa fa-times" href="javascript:;"></a> -->
										<span>Export:</span>
										<a target="_blank" class="btn-color btn-outline btn btn-outline red" title="Export To Excel" href="<!-- php: = Cake\Routing\Router::url(['controller' => 'CreditClaims', 'action' => 'exportDataToExcel', 1]) -->"> Excel <!-- php: = $this->Html->image('../assets/img/excel.png', ['style' => 'width: 25px; height: 25px']) --></a>
										<a target="_blank" class="btn-color btn-outline btn btn-outline red" title="Export To PDF" href="<!-- php: = $this->Url->build(['controller' => 'CreditClaims', 'action' => 'exportDataToPdf', 1]) -->"> PDF <!-- php: = $this->Html->image('../assets/img/pdf.png', ['style' => 'width: 25px; height: 25px']) --></a>
										<a class="btn-color btn-outline btn btn-outline red" title="Export To XML" href="<!-- php: = Cake\Routing\Router::url(['controller' => 'CreditClaims', 'action' => 'generateNhisXml']) -->"> XML <!-- php: = $this->Html->image('../assets/img/folder.png', ['style' => 'width: 25px; height: 25px']) --></a>
									</div>
								</div>
								<div class="card-body">
									<div class="row">
								  ...
								  <div class="table-scrollable">
									<table class="table table-hover order-column full-width table-checkable">
										...
										<tbody>
										<!-- php: $i = 0; -->
										<!-- php: foreach ($paid_claims as $invoice): -->
											<!-- php: $i++; -->
											<tr>
...
export default function ElementElementCreditclaimsSubmittedPaid() {
