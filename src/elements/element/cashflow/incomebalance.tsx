...
<div class="card card-topline-<!-- php: = $theme1 -->">
    ...
    <div class="card  card-box">
        <div class="card-head">
            <header>Income Balance and Profit & Loss Report</header>
        </div>
        <div class="card-body ">
            <!-- <div class="row">
            ...
            <div class="container-fluid d-flex justify-content-end p-3">
                <!-- <button class="btn btn-xs btn-primary">Income Balance Statement</button> -->
            ...
            <div class="row mt-3">
                <div class="col-md-6">
                    <div class="">
                        ...
                        <div class="col-md-12 card p-3">
                            <small class="text-dark mb-0 pb-0">TAXES PAYABLE ON REVENUE</small>
                        ...
                        <div class="col-md-12 card p-3">
                            <small class="text-dark mb-0 pb-0">NET REVENUE</small>
                            <h3 id="approved" style="margin-top:0px!important;margin-bottom:0px!important;"
                                class="my-0 pb-0">Loading..</h3>
                            <!-- <small class="text-secondary mt-0">1-15 days</small> -->
                        </div>
                        <div class="col-md-12 card p-3">
                            <small class="text-dark mb-0 pb-0">GROSS EXPENDITURE</small>
                            <h3 id="approved" style="margin-top:0px!important;margin-bottom:0px!important;"
                                class="my-0 pb-0">Loading..</h3>
                            <!-- <small class="text-secondary mt-0">1-15 days</small> -->
                        </div>
                        <div class="col-md-12 card p-3">
                            <small class="text-dark mb-0 pb-0">TAXES PAYABLE ON EXPENSES</small>
                            <h3 id="approved" style="margin-top:0px!important;margin-bottom:0px!important;"
                                class="my-0 pb-0">Loading..</h3>
                            <!-- <small class="text-secondary mt-0">1-15 days</small> -->
                        </div>
                        ...
                        <div class="col-md-12 card p-3">
                            <small class="text-dark mb-0 pb-0">GROSS INCOME</small>
                            <h3 id="approved" style="margin-top:0px!important;margin-bottom:0px!important;"
                                class="my-0 pb-0">Loading..</h3>
                            <!-- <small class="text-secondary mt-0">1-15 days</small> -->
                        </div>
                        ...
                        <div class="col-md-12 card p-3">
                            <small class="text-dark mb-0 pb-0">INCOME BALANCE</small>
                            <h3 id="approved" style="margin-top:0px!important;margin-bottom:0px!important;"
                                class="my-0 pb-0">Loading..</h3>
                            <!-- <small class="text-secondary mt-0">1-15 days</small> -->
                        </div>
                        <div class="col-md-12 card p-3">
                            <small class="text-dark mb-0 pb-0">PROFIT (+)</small>
                            <h3 id="approved" style="margin-top:0px!important;margin-bottom:0px!important;"
                                class="my-0 pb-0">Loading..</h3>
                            <!-- <small class="text-secondary mt-0">1-15 days</small> -->
                        </div>
                        <div class="col-md-12 card p-3">
                            <small class="text-dark mb-0 pb-0">LOSS (-)</small>
                            <h3 id="approved" style="margin-top:0px!important;margin-bottom:0px!important;"
                                class="my-0 pb-0">Loading..</h3>
                            <!-- <small class="text-secondary mt-0">1-15 days</small> -->
                        </div>
                ...
                <div class="col-md-6">
                    <div class="">
                        ...
                        <div class="col-md-12 card p-3">
                            <small class="text-dark mb-0 pb-0">SUM TAXES PAYABLE</small>
                            <h3 id="approved" style="margin-top:0px!important;margin-bottom:0px!important;"
                                class="my-0 pb-0">Loading..</h3>
                            <!-- <small class="text-secondary mt-0">1-15 days</small> -->
                        </div>
            ...
            <div class="row mt-3 d-none align-items-center d-none">
             ...
             <div class="table-responsive mt-5 d-none">
                <table class="table" id="incomebalance-table">
                     <thead>
                        <tr>
                            <!-- <th>Period</th> -->
                            <th>Department</th>
...
<script>
    $("#incomebalance-table").DataTable();
</script>
`;

export default function ElementElementCashflowIncomebalance() {
