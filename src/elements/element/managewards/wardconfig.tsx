...
<div class="row">
	<div class="borderBox light bordered col-md-12">
		<div class="borderBox-title tabbable-line">
			<div class="caption">
				<span class="caption-subject font-dark bold uppercase">Ward Configuration</span>
			</div>
		...
		<div class="borderBox-body">
			<div class="tab-content">
				<div class="tab-pane " id="config_add">
					<h4>Add ward configuration</h4>
					<!-- php: = $this->Form->create($bed, ['url' => ['controller' => 'ManageWards', 'action' => 'addConfiguration']]); -->
						<div class="form-group row">
							<label class="control-label col-md-4">Separator
								<span class="required"> * </span>
							</label>
							<div class="col-md-5">
								<input type="text" name="symbol" id="symbol" data-required="1" placeholder="Enter separator" class="form-control input-height" required /> 
							</div>
						</div>
						
						<div class="form-group row">
							<label class="control-label col-md-4">Naming Convention
								<span class="required"> * </span>
							</label>
							<div class="col-md-5">
								<SearchableSelectField class="form-control input-height" name="convention" id="convention" required>
						...
						<div class="card-body ">
						  <div class="table-scrollable">
							<table class="table table-hover table-checkable order-column full-width customDataTable">
								<thead>
									<tr>
										<th class="left">Separator Symbol</th>
										<th class="left">Convention</th>
										<!-- <th class="left">Action</th> -->
									</tr>
								</thead>
								<tbody>
								<!-- php: $x = 1; foreach ($wardConfigurations as $value): -->
								
									<tr class="odd gradeX">
										<!-- <td class="left"></?=$x?></td> -->
										<td class="left"><!-- php: =$value->symbol --></td>
										<td class="left"><!-- php: =$value->convention --></td>
										<!-- <td class="left">
											<a data-toggle="modal" data-target="#editBedDialogue_</?= $value->id ?>" href="javascript:" class="btn </?= Cake\Core\Configure::read('Classes.Edit') ?> btn-xs">
												Edit
											</a>
...
export default function ElementElementManagewardsWardconfig() {
