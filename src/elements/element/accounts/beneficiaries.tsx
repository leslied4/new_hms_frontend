...
<div class="row">
	<div class="borderBox light bordered col-md-12">
		<div class="borderBox-title tabbable-line">
			<div class="caption">
				<span class="caption-subject font-dark bold uppercase">Beneficiaries</span>
			</div>
			<ul class="nav nav-tabs">
				<li class="nav-item">
					<a href="#beneficiaries_add" data-toggle="tab"> Add </a>
				</li>
				<li class="nav-item">
					<a href="#beneficiaries_view" data-toggle="tab"> View </a>
				</li>
			</ul>
		</div>
		<div class="borderBox-body">
			<div class="tab-content">
				<div class="tab-pane " id="beneficiaries_add">
					<h4 class="mt-4">Add Beneficiaries</h4>
					<!-- php: = $this->Form->create(null, ['url' => ['controller' => 'Accounts', 'action' => 'addBeneficiaries']]); -->
				...
				<div class="tab-pane active" id="beneficiaries_view">
					<div class="card  card-box">
						<div class="card-body ">
						  <div class="table-scrollable">
							<table id="beneficiaries-table" class="table table-hover table-checkable order-column full-width slimDataTable">
								<thead>
									<tr>
								...
								<tbody>
										<!-- php: foreach($benefis as $benefit){ -->
                                            <tr>
                                                <td><!-- php: = $benefit->title --></td>
                                                <td><!-- php: = $benefit->description --></td>
                                                <td>
                                                    <a href="javascript:" data-toggle="modal" data-target="#editbenefitModal_<!-- php: =$benefit->id -->" class="btn btn-warning btn-xs">Edit</a>
                                                    <a href="<!-- php: = $this->Url->build(['controller' => 'Accounts', 'action' => 'deleteBeneficiaries', $benefit->id]) -->" class="btn btn-danger btn-xs">Delete</a>
                                                </td>
                                            </tr>
...
<!-- php: foreach($benefis as $benefit){ -->
<div class="modal fade" id="editbenefitModal_<!-- php: =$benefit->id -->" tabindex="-1" aria-hidden="true">
            ...
            <div class="container px-0 border border-2 border-danger">
                <div class="container-fluid pr-0 bg-danger">
                    <div class="d-flex align-items-center justify-content-between">
                        <h4 class="text-slate-900 my-0">Edit Beneficiary
                            Information</h4>
                        <div>
                ...
                <div class="container bg-white p-2">
                    <div class="container my-2 p-3">
                        <!-- php: = $this->Form->create(null, ['url' => ['controller' => 'Accounts', 'action' => 'editBeneficiaries',$benefit->id]]); -->
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="text" name="title" id="title" data-required="1" placeholder="Enter Title"
                                    class="form-control input-height" value="<!-- php: = $benefit->title -->" required />
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <textarea name="description" id="description" data-required="0"
                                    ...
                                    class="form-control input-height"><!-- php: = $benefit->description --></textarea>
                            </div>
                        </div>
                    </div>
                </div>
...
export default function ElementElementAccountsBeneficiaries() {
