const rawHtml = `
<style>
    .hematopathology-report-container {
    ...
    .hematopathology-report-container .report-header {
        text-align: center;
        margin-bottom: 2rem;
        padding-bottom: 1rem;
    ...
    .hematopathology-report-container .report-header h1 {
        color: #2c3e50;
        font-size: 2rem;
        margin-bottom: 0.5rem;
    }

    .hematopathology-report-container .report-section {
        margin-bottom: 2rem;
        padding: 1.5rem;
        /* background: #f8f9fa; */
        border-radius: 8px;
    ...
    .hematopathology-report-container .report-section h2 {
        color: #2c3e50;
        font-size: 1.5rem;
        margin-bottom: 1rem;
    ...
    .hematopathology-report-container .report-section h3 {
        color: ;
        font-size: 1.2rem;
        margin: 1rem 0;
    }

    .hematopathology-report-container .data-grid {
        display: grid;
        grid-template-columns: repeat(auto-fit, minmax(300px, 1fr));
        gap: 1rem;
    }

    .hematopathology-report-container .data-item {
        margin-bottom: 0.5rem;
    }

    .hematopathology-report-container .data-label {
        font-weight: 600;
        color: #495057;
        margin-bottom: 0.25rem;
    }

    .hematopathology-report-container .data-value {
        color: #212529;
    }

    .hematopathology-report-container .checkbox-list {
        list-style: none;
        padding: 0;
        margin: 0;
    }

    .hematopathology-report-container .checkbox-list li {
    ...
    .hematopathology-report-container .text-block {
    ...
    .hematopathology-report-container .unit {
        color: #6c757d;
        font-size: 0.875rem;
        margin-left: 0.25rem;
    }
...
<div class="hematopathology-report-container">
...
export default function ElementElementRequestLabsHematopathologyViewReport() {
