...
<style>
    ...
    .cytology-report .report-header h1 {
        color: #2c3e50;
        margin-bottom: 10px;
    }

    .cytology-report .report-section {
        margin-bottom: 25px;
        padding: 15px;
    ...
    .cytology-report .data-grid {
        display: grid;
        grid-template-columns: repeat(2, 1fr);
        gap: 15px;
    }

    .cytology-report .data-item {
        margin-bottom: 10px;
    }

    .cytology-report .data-label {
        font-weight: bold;
        color: #555;
        margin-bottom: 3px;
    }
    ...
    .cytology-report .checkbox-list {
        list-style: none;
        padding: 0;
        margin: 0;
    }

    .cytology-report .checkbox-list li {
        margin-bottom: 5px;
        padding-left: 20px;
        position: relative;
    }

    .cytology-report .checkbox-list li:before {
        content: "✓";
        position: absolute;
        left: 0;
        color: #27ae60;
    ...
    .cytology-report .full-width {
        grid-column: 1 / -1;
    }

    .cytology-report .text-block {
    ...
    @media print {
        .cytology-report .cytology-report {
            box-shadow: none;
        }
...
export default function ElementElementRequestLabsCytologicalViewReport() {
