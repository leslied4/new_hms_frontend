	...
	<div class="borderBox light bordered col-md-12">
		<div class="borderBox-title tabbable-line">
			...
			<ul class="nav nav-tabs">
				<li class="nav-item">
					<a href="#stockitems_add" data-toggle="tab"> Add Surgery</a>
				</li>
				<li class="nav-item">
					<a href="#stockitems_view" data-toggle="tab"> Surgery History </a>
				</li>
			</ul>
		</div>
		<div class="borderBox-body">
			<div class="tab-content">
				<div class="tab-pane " id="stockitems_add">
					<h4>Add a new Surgery</h4>
					<!-- php: = $this->Form->create($stock, ['url' => ['controller' => 'InventorySurgery', 'action' => 'addStock']]); -->
																													
						<div class="form-group row">
							<label class="control-label col-md-4">Surgery Name
...
export default function ElementElementInventorySurgeryStocks() {
