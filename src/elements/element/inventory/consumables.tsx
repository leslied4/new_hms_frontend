						...
						<table class="table table-hover full-width">
							...
							<!-- php: $x = 1; foreach ($selectedItems as $value): -->
								...
								<tr class="odd gradeX">
									...
									<td class="left"><!-- php: = $value->brand_name --></td>
									<td class="left"><!-- php: = $value->manufacturer->name --></td>
									<td class="left"><!-- php: = isset($value->drug_class) ? $value->drug_class->name : '' --></td>
									<td class="left"><!-- php: = $value->item_type->type_name --></td>
...
export default function ElementElementInventoryConsumables() {
