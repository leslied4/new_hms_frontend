			...
			<div class="card  card-box">
				<div class="card-body ">
					...
					<table class="table table-hover order-column full-width customDataTable">
						...
						<tbody>
						<!-- php: $x = 1; if (isset($stockList) && $stockList != null) { foreach ($stockList as $value): $itemExpired = $value->expiry_date != null && $value->expiry_date->isFuture(); // echo $value->expiry_date; // echo '<br>'; // echo $itemExpired; // echo... -->
							<tr class="odd gradeX" style="<!-- php: = $itemExpired ? 'background: #FAF5D2;' : '' -->">
								...
								<td class="left"><!-- php: = $value->quantity_left --> <!-- php: = $itemExpired ? "<span style='margin-bottom: 5px' class='badge badge-danger'>Expiring</span>" : '' --></td>
								<td class="left">
...
export default function ElementElementInventoryExpiringStocks() {
