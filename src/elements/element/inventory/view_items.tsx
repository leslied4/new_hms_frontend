					...
					<div class="card-body ">
						...
						<table class="table table-hover full-width">
							...
							<!-- php: $x = 1; foreach ($selectedItems as $value): -->
								...
								<tr class="odd gradeX">
									<td class="left"><!-- php: = $value->full_name -->. <span style="color: indigo"><!-- php: = $value->brand_name --></span></td>
									<td class="left"><!-- php: = $value->item_code --></td>
									<td class="left"><!-- php: = $value->has('item_type') ? $value->item_type->type_name . " (" . $value->item_type->quantity . ")" : '' --></td>
									<!-- php: if (isset($showCategory) && $showCategory == true) { -->
									...
									<td class="left">
										<a type="button" href="javascript:" onclick="editItemModal('<!-- php: = $value->id -->')"
...
export default function ElementElementInventoryViewItems() {
