...
<div class="card  card-box">
    <div class="card-head">
        <header>Rejected Transfers</header>
    </div>
    <div class="card-body ">
        <div class="row">
                            ...
                            <div>
                                <div class="d-flex align-items-start">
                                    ...
                                    <div style="border:none; box-shadow: none; background:transparent; color: #000"
                                        ...
                                        Select Department: <SearchableSelectField name="" id="rejected_department" class="form-control ml-3" onchange="filterRejectedTransfer()">
                                        ...
                                        <div class="borderBox-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="table-responsive">
                                                    <table id="view-rejected_transfer-table" class="table table-hover order-column full-width">
                                                        <thead>
                                                            <tr>
                                                                <th>Item Name/ID</th>
                                                                <th>Batch No. (Exp)</th>
...
<script>
    ...
    function filterRejectedTransfer() {
        getAllRejectedTransfers($('#rejected_department').val())
    }

    function getAllRejectedTransfers(department_id) {
        table = $('#view-rejected_transfer-table').DataTable();
        table.destroy();
        $('#view-rejected_transfer-table').DataTable({
            "ordering": false,
            ajax:  {
                url: "<!-- php: = $this->Url->build(['controller' => 'Inventory', 'action' => 'filterTransfers',3,]) -->/"+department_id,
                dataSrc: 'data'
            },
            columns: [
                {
    ...
    $(document).ready(function() {  
        getAllRejectedTransfers('')
    })
</script>
`;

export default function ElementElementInventoryRejectedTransfers() {
