									...
									<div class="settings-list">
					                    <div class="setting-item">
					                        ...
					                        <div class="setting-set">
					                           <SearchableSelectField class="sidebar-pos-option form-control input-inline input-sm input-small ">
					                    ...
					                    <div class="setting-item">
					                        ...
					                        <div class="setting-set">
					                           <SearchableSelectField class="page-header-option form-control input-inline input-sm input-small ">
					                    ...
					                    <div class="setting-item">
					                        ...
					                        <div class="setting-set">
					                           <SearchableSelectField class="sidebar-menu-option form-control input-inline input-sm input-small ">
					                    ...
					                    <div class="setting-item">
					                        ...
					                        <div class="setting-set">
					                           <SearchableSelectField class="page-footer-option form-control input-inline input-sm input-small ">
...
export default function ElementElementChatSideBar() {
