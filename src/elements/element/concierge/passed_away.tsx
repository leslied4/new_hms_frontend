                        ...
                        <div class="row justify-content-center">
                            <div style="" class="container-fluid text-center p-3 mt-3 mb-2">
                                <div style="z-index:2;" class="container-fluid pl=0">
                                    ...
                                    <div class=" mt-2">
                                        <table class="table table-hover order-column full-width" id="passed_away" style="width: 100%">
                                            <thead>
                                                <tr>
                                                    <th>Date Recorded</th>
                                                    <th>Patient</th>
...
<script>
    ...
    function requestPassedAway() {
        table = $('#passed_away').DataTable();
        table.destroy();
        $('#passed_away').DataTable({
            "ordering": false,
            ajax:  {
                url: "<!-- php: = $this->Url->build(['controller' => 'Concierge', 'action' => 'patientPassedAway',]) -->",
                dataSrc: 'data'
            },
            columns: [
                {
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        ...
                        return \`\${row.next_of_kin || ''} \${row.next_of_kin_relation || ''} \${row.next_of_kin_phone || ''}\`
                    }
                },
                {
                    data: "name",
...
export default function ElementElementConciergePassedAway() {
