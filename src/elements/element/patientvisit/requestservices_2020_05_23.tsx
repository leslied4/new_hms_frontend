													...
													<!-- php: if($isCurrentVisit) { -->
														<!-- php: = $this->Form->create(null, ['id' => 'medicationForm', 'url' => ['controller' => 'RequestMedications', 'action' => 'addRequestMedication', $patient->id, $selectedVisit->id], 'id' => 'medicationForm']); -->
															<tfoot style="background: #fcfcfc">
																<tr>
																	<td style="border-top: 3px solid #ececec; height: 0px" colspan="7">
																	</td>
																</tr>
																<tr>
																	<td></td>
																	...
																	<td>
																		<input type="text" name="instructions" id="instructions" data-required="0" placeholder="Instructions" class="form-control input-height" style="height: 35px !important; margin-top: -10px;" />
																	</td>
																	<td>
																...
																<tr>
																	<td></td>
																	<td>
																		<SearchableSelectField class="form-control input-height selectpicker show-menu-arrow show-tick" title="Med Type" data-size="5" data-live-search="true" class="form-control input-height" name="medication_type_id" id="medication_type_id" >
																			<!-- php: foreach($medicationTypes as $key => $medicationType) { -->
																					<option value="<!-- php: = $key -->"><!-- php: = h($medicationType) --></option>
																				<!-- php: } -->
																		</SearchableSelectField>
																	</td>
																	<td><input type="text" name="allergy" id="allergy" placeholder="Allergy" class="form-control input-height" style="height: 35px !important; margin-top: -10px;" /></td>
																	<td>
																	...
																	<td>
																		...
																		<SearchableSelectField class="form-control input-height selectpicker show-menu-arrow show-tick" title="Bill To" data-required="1" data-size="5" data-live-search="true" class="form-control input-height" name="bill_to_id" id="bill_to_id" required >
																			...
																			<!-- php: foreach($providers as $provider) { -->
																					<option <!-- php: = $billTo == $provider->id ? 'selected' : '' --> value="<!-- php: = $provider->id -->" data-content="Bill To: <!-- php: = $provider->insurance_profile->name --><span class='badge badge-primary'><!-- php: = $provider->name --></span>  <span class='badge badge-danger'><!-- php: = $provider->insurance_profile->has('insurance_profile_type') ? $provider->insurance_profile_type->name : '' --></span>"></option>
																				<!-- php: } -->
																		</SearchableSelectField>
																	</td>
																	<td>
																		<button type="submit" class="btn btn-info form-control" id="submitMedication" style="height: 35px !important; margin-top: -10px;">Add</button>
																	</td>
																</tr>
															</tfoot>
														<!-- php: = $this->Form->end(); -->
...
export default function ElementElementPatientvisitRequestservices20200523() {
