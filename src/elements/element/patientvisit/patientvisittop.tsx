            ...
            <div class="card-body no-padding"
                ...
                <div class="row">
                    <div class="profile-userpic col-md-2 right-border"
                        ...
                        <!-- php: if(null !==($selectedVisit) && $selectedVisit != null && $selectedVisit->admitted == 1 && !$selectedVisit->has('visit_outcome')) { -->
                            ...
                            <li class="list-group-item py-0" style="border: none; border-bottom:0px; padding-top: 22px; padding-bottom: 0px;">
                                ...
                                <!-- php: if(null !==($selectedVisit) && $selectedVisit != null && $selectedVisit->admitted != 1 && $isCurrentVisit) { -->
                                        ...
                                        <a id="admit_button" type="button" href="#" data-toggle="modal" data-target="#admitDialogue"
                                            class="btn btn-xs btn-circle  btn-info pull-right" ><i
                                ...
                                <!-- php: if($isCurrentVisit) { -->
                                    ...
                                    <button id="admit_button" type="button" href="javascript" onclick="pathwayTriggerModal()"
                                        class="btn btn-xs btn-circle  btn-info pull-right">Clinical Pathways
                                    </button>
                                <!-- php: } -->
                    ...
                    <div class="modal fade bd-example-modal-lg" id="pathway_modal" tabindex="-1" role="dialog"
                        aria-labelledby="select" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                            <div class="modal-content">
                                <div class="modal-body pathway_information p-0 m-0" >
...
<script>
    ...
    const pathway_link = '<!-- php: =$this->Url->build([ 'controller'=> 'PatientVisits', 'action'=>'clinicalPathways', isset($patient) ? $patient->id : null, isset($selectedVisit) ? $selectedVisit->id : null ]) -->/'
...
export default function ElementElementPatientvisitPatientvisittop() {
