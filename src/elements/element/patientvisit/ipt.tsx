...
<section style="" class="card">
	<div class="card-body">
		<h4 class="bold text-uppercase ml-3">IPT</h4>
		...
		<!-- php: if ($isCurrentVisit) { -->
			<div class="row mt-4 pl-3">
				<a class="btn btn-sm text-slate-900 mr-2" style="background-color: #e74c3c;" onclick="javascript:$('#prescriptionForm').toggle(500); moveToId('prescriptionForm'); currentForm ='prescription' ">Add IPT</a>
			</div>
		<!-- php: } -->
		<!--Add Medication-->
		<!-- php: if ($isCurrentVisit) { -->
			...
			<div class="form-body">
				<div class="row">
					<div class="col-md-6">
						...
						<div class="form-group row">
							...
							<div class="col-md-7">
								<div>
									<input type="text" id="administer_dose_prescription" data-required="1" placeholder="Administer Dose" onchange="$('#prescriptionForm').validate().element('#administer_dose_prescription');" class="form-control  ui-autocomplete-input" required>
								</div>
								<div class="mt-2">
						...
						<div class="form-group row" id="prnDosageInstructionToggles">
							...
							<div class="col-md-7">
								...
								<textarea class="form-control full-width" placeholder="Instruction" id="prescription_instruction_info" rows="4" cols="45">
								</textarea>
							</div>
						</div>
				...
				<input type="hidden" id="is_pregnancy_ipt" name="is_pregnancy_ipt" value="1">
				<div class="row">
...
<div class="modal fade" id="doseCalculatorModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog  modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="mb-2">
                <span class="label label-lg bg-primary text-uppercase "><b>Dose Calculation for “<span class="modal_drug_title"></span>”</b>
                </span>
            </div>
...
<script>
    ...
    const getAllMedications_link = "<!-- php: = $this->Url->build(['controller' => 'RequestMedications', 'action' => ( $continuousCare ? 'getAllVisitIptMedications' : 'getAllVisitIptMedications'), $patient->id, $selectedVisit->id, ]) -->"
...
export default function ElementElementPatientvisitIpt() {
