    ...
    <div class="borderBox-body">
        <div class="tab-content">
                            ...
                            <!-- php: = $this->Form->create($outcomeObject, ['id' => 'deliveryOutcomeForm', 'url' => ['controller' => 'Maternal', 'action' => ($outcomeObject != null ? 'updateDeliveryOutcome' : 'addDeliveryOutcome'), $patient->id, $selectedVisit->id, ($outcomeOb... -->
                                ...
                                <div class="form-body">                                    
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-7">
                                            <SearchableSelectField class="form-control input-height" name="blood_transfusion" id="out_blood_transfusion">
                                                <option value="">Select...</option>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-7">
                                            <input type="text" value="<!-- php: = $outcomeObject != null ? $outcomeObject->attendant_name : '' -->" name="attendant_name" id="out_attendant_name" placeholder="Name of Attendant" class="form-control input-height" required  /> 
                                        </div>            
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        <label class="control-label col-md-3">Breastfeeding Started Withing 30mins?
                                        </label>
                                        <div class="col-md-7">
            ...
            <div class="tab-pane" id="maternal_delivery_for_child">
                <div>
                    <div class="card-head legend-head">
                        <header style="font-weight: 100;">Child's Condition</header>
                        <div style="float: right;">
                            <a id="add_delivery_child_button" class="btn btn-sm btn-<!-- php: = $theme2 -->" onclick="$('#no_delivery_child_div, #delivery_child_list_div, #add_delivery_child_button').hide(0);$('#add_delivery_child_div, #view_deliverys_child_button').show({ direction: 'top' }, 3000)"><!-- php: = (!isset($babyCondition) || $babyCondition == null) ? 'Add' : 'Update' --> Baby's Condition</a>
                    ...
                    <div class="card card-box" id="add_delivery_child_div" style="display: none;">
                        <div class="card-body" id="bar-delivery_child_div">                       
                            <!-- php: = $this->Form->create($babyCondition, ['id' => 'deliveryBabyConditionForm', 'url' => ['controller' => 'Maternal', 'action' => ($babyCondition != null ? 'updateBabyCondition' : 'addBabyCondition'), $patient->id, $selectedVisit->id, ($babyCon... -->
                                <!-- php: = $this->Form->hidden('patient_pregnancy_id', ['value' => $selectedVisit->pregnancy_id]) -->
                                <div class="form-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-7">
                                            <SearchableSelectField class="form-control input-height" name="resuscitation" id="delc_resuscitation">
                                                <option value="">Select...</option>
                                                <!-- php: foreach($YESNO as $key => $value) { -->
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-7">
                                            <SearchableSelectField class="form-control input-height" name="birth_complications" id="delc_birth_complications">
                                                <option value="">Select...</option>
                                                <!-- php: foreach($YESNO as $key => $value) { -->
                                    ...
                                    <div class="form-group row">
                                        <label class="control-label col-md-3">Complications (Referred To)
                                        </label>
                                        <div class="col-md-7">
                    ...
                    <!-- php: if(!isset($babyCondition) || $babyCondition == null) { -->
                    ...
                    <!-- php: } else { -->
                        <div class="card-body " id="delivery_child_list_div">
                            <div class="card-body no-padding height-9">
                                <ul class="list-group list-group-unbordered">
                                    <li class="list-group-item">
                                        <b>Delivery Outcome</b>
                                        <div class="profile-desc-item pull-right"><!-- php: = $babyCondition->delivery_outcome --></div>
                                    </li>
                                    <li class="list-group-item">
                                        <b>Sex of Baby</b>
                                        <div class="profile-desc-item pull-right"><!-- php: = $babyCondition->sex --></div>
                                    </li>
                                    <li class="list-group-item">
                                        <b>Number of Babies</b>
                                        <div class="profile-desc-item pull-right"><!-- php: = $babyCondition->number_of_babies --></div>
                                    </li>
                                    <li class="list-group-item">
                                        <b>Baby's Weight</b>
                                        <div class="profile-desc-item pull-right"><!-- php: = $babyCondition->weight --> kg</div>
                                    </li>
                                    <li class="list-group-item">
                                        <b>Baby's Length</b>
                                        <div class="profile-desc-item pull-right"><!-- php: = $babyCondition->length --> cm</div>
                                    </li>
                                    <li class="list-group-item">
                                        <b>Head Circumference</b>
                                        <div class="profile-desc-item pull-right"><!-- php: = $babyCondition->head_circumference --> cm</div>
                                    </li>
                                    <li class="list-group-item">
                                        <b>APGAR Score</b>
                                        <div class="profile-desc-item pull-right">1min <!-- php: = $babyCondition->apgar_score_1 --> / 10</div>
                                    </li>
                                    <li class="list-group-item">
                                        <b>APGAR Score</b>
                                        <div class="profile-desc-item pull-right">5min <!-- php: = $babyCondition->apgar_score_5 --> / 10</div>
                                    </li>
                                    <li class="list-group-item">
                                        <b>Resuscitation</b>
                                        <div class="profile-desc-item pull-right"><!-- php: = $babyCondition->resuscitation --></div>
                                    </li>
                                    <li class="list-group-item">
                                        <b>Congenital Malformation</b>
                                        <div class="profile-desc-item pull-right"><!-- php: = $babyCondition->congenital_malformation --></div>
                                    </li>
                                    <li class="list-group-item">
                                        <b>Complications at Birth</b>
                                        <div class="profile-desc-item pull-right"><!-- php: = $babyCondition->birth_complications --></div>
                                    </li>
                                    <li class="list-group-item">
                                        <b>Complications (Diagnosis)</b>
                                        <div class="profile-desc-item pull-right"><!-- php: = $babyCondition->complications_diagnosis --></div>
                                    </li>
                                    <li class="list-group-item">
                                        <b>Complications (Referred to)</b>
                                        <div class="profile-desc-item pull-right"><!-- php: = $babyCondition->complications_referred_to --></div>
                                    </li>
                                </ul>
                            </div>
                        </div>
                            ...
                            <!-- php: = $this->Form->create($deliverySummary, ['id' => 'deliveryDeliverySummaryForm', 'url' => ['controller' => 'Maternal', 'action' => ($deliverySummary != null ? 'updateDeliverySummary' : 'addDeliverySummary'), $patient->id, $selectedVisit->id,... -->
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-7">
                                            <SearchableSelectField class="form-control input-height" name="cord_care" id="dels_cord_care">
                                                <option value="">Select...</option>
                                                <!-- php: foreach($YESNO as $key => $value) { -->
                            ...
                            <div class="card-body no-padding height-9">
                                <ul class="list-group list-group-unbordered">
                                    ...
                                    <li class="list-group-item">
                                        ...
                                        <div class="profile-desc-item pull-right"><!-- php: = $deliverySummary->baby_suckling_established --> cm</div>
                                    </li>
                                    <li class="list-group-item">
                                        <b>Meconium Passed</b>
                                    ...
                                    <li class="list-group-item">
                                        <b>Cord Care</b>
                                        <div class="profile-desc-item pull-right"><!-- php: = $deliverySummary->cord_care --></div>
                                    </li>
                                    <li class="list-group-item">
                                        <b>Vitamin K</b>
...
export default function ElementElementPatientvisitMaternalDelivery20210503() {
