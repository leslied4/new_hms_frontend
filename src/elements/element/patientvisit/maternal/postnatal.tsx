        ...
        <div class="tab-content">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-7">                                                    
                                                        <SearchableSelectField class="form-control input-height" data-size="10" name="urine_protein" id="post_urine_protein" >
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-7">
                                                        <SearchableSelectField class="form-control input-height" data-size="10" name="urine_sugar" id="post_urine_sugar" >
                                                            <option value="">--Select--</option>
                                                            <option value="-">-</option>
                                                            <option value="+">+</option>
                                                            <option value="++">++</option>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-7">
                                                        <input type="text" min="1" name="iron" id="iron" data-required="1" placeholder="Enter supplied days" class="form-control input-height" />
                                                    </div>
                                                </div>   
                        ...
                        <div class="card-body " id="postnatal_list_div">
                            <div class="table-scrollable">        
                                <table class="table table-hover order-column full-width customDataTable" id="maternal_postnatal_table">
                                    ...
                                    <tbody>
                                        <!-- php: foreach (array_reverse($postnatalList) as $postnatal): -->
                                        <tr class="odd gradeX">
                                            ...
                                            <td><!-- php: = $postnatal->temperature --></td>
                                            <td><!-- php: = $postnatal->urine_protein --></td>
                                            <td><!-- php: = $postnatal->urine_sugar --></td>
                                            <td><!-- php: = $postnatal->height --></td>
                                            <td><!-- php: = $postnatal->colour --></td>
                                            <td><!-- php: = $postnatal->odour --></td>
                                            <td><!-- php: = $postnatal->incision --></td>
                                            <td><!-- php: = $postnatal->breast_nipple --></td>
                                            <td><!-- php: = $postnatal->mood --></td>
                                            <td><!-- php: = $postnatal->iron --></td>
                                            <td><!-- php: = $postnatal->remarks --></td>
                                            <td><span class="badge badge-<!-- php: = $theme2 -->"></i><!-- php: = $postnatal->date_of_next_visit != null ? $postnatal->date_of_next_visit->i18nFormat('d/M/Y') : '' --></span></td>
                                        </tr>
                                        <!-- php: endforeach; -->
                                    </tbody>
                                </table>                                                                                                
            ...
            <div class="tab-pane" id="maternal_postnatal_for_child">
                <div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <fieldset>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-7">
                                                        <textarea type="text" name="remarks" id="remarks" data-required="1" placeholder="Provide comment" class="form-control textarea-height"></textarea>
                                                    </div>
                                                </div>
                    ...
                    <!-- php: } else { -->
                        <!-- php: $childPostnatalScheme = [ ['name' => 'Date', 'keyIndex' => 'date_added', 'type' => 'date', 'unit' => ''], ['name' => 'Weight (kg)', 'keyIndex' => 'weight', 'type' => 'number', 'unit' => 'kg'], ['name' => 'Length (cm)', 'keyIndex' => 'length... -->
                        <div class="card-body " id="postnatal_child_list_div">
                            <div class="table-scrollable">                                
                                <table class="table table-hover order-column full-width" id="maternal_child_postnatal_table">
                                <!-- table class="table table-hover order-column full-width customDataTable" id="maternal_child_postnatal_table" -->
                                    <thead>
                                        <tr>
                                            <th class="active-table-header">Postnatal Care</th>
                                            <!-- php: foreach($postnatalChildList as $value) { -->
                                                <th class="active-table-header">Visit - <!-- php: = $value->date_added != null ? $postnatal->date_added->i18nFormat('d/M/Y') : '' --></th>
                                            <!-- php: } -->
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <!-- php: foreach($childPostnatalScheme as $scheme) { -->
                                            <tr class="odd gradeX">
                                                <th class="active-table-header"><!-- php: = $scheme['name'] --></th>
                                                <!-- php: foreach ($postnatalChildList as $value): -->
                                                    <!-- php: // debug($value[$scheme['keyIndex']]); exit; -->
                                                    <td>
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$('#maternalPostnatalTab a[data-toggle="tab"]').on('shown.bs.tab', function () {
			localStorage.setItem('maternalPostnatalLastTab', $(this).attr('href'));
		});
		
		// display last tab if exist
		var maternalPostnatalLastTab = localStorage.getItem('maternalPostnatalLastTab');
...
export default function ElementElementPatientvisitMaternalPostnatal() {
