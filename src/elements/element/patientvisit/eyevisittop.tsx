            ...
            <div class="card-body no-padding"
                ...
                <div class="row">
                    <div class="profile-userpic col-md-2 right-border"
                        ...
                        <span class="mdl-badge custom-badge" style="background:red; padding: 0; margin:0" data-badge="Eye Care"></span>
                    ...
                    <div class="profile-usertitle col-md-3 mt-0">
						...
						<div class="d-flex justify-content-center mt-2">
                            <button class="btn btn-xs" onclick='callNextPatientForVisit()'>F12: Next Patient</button>
                            <button class="btn btn-xs ml-1" onclick='noShowPatientForVisit()'>F10: No Show</button>
                                                        ...
                                                        <div style="height:400px;overflow-y:scroll;" class="col-md-8">
                                                            <div mbsc-page class="demo-basic-usage">
                                                                <div style="height:100%">
                                                                    <div id="demo-daily-events-routine_top"></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
...
<script>
    var recur_data = [];
    var insta = mobiscroll.eventcalendar('#demo-daily-events-routine_top', {
...
export default function ElementElementPatientvisitEyevisittop() {
