		...
		<div class="borderBox-body">
			<div class="tab-content">
				<div class="tab-pane" id="visitReportTab">
					<h4 class="font-bold mt-5">Patient Documentation Report</h4>
					...
					<div class="tools d-flex justify-content-start">
						...
						<a href="<!-- php: = Cake\Routing\Router::url(['controller' => 'Patients', 'action' => 'chiroNotesVisitReport', $patient->id, $selectedVisit->id]) -->" target="_blank" class="export-link" escape=false>
							<!-- php: = $this->Html->image('../assets/img/pdf.png',['class' => 'export-action', 'style' => 'width: 30px; height: auto']) -->

						</a>
					</div>
					<h4 class="font-bold mt-5">Assessment Plan And Progress Report</h4>
					<p class="text-secondary">In this report, you will find summarised health record including patient health information, medications and problems list and account balances.</p>
					<div class="tools d-flex justify-content-start">
						<!--<a class="fa fa-repeat btn-color box-refresh" href="javascript:;"></a>
						<a class="t-collapse btn-color fa fa-chevron-down" href="javascript:;"></a>
						...
						<a href="<!-- php: = Cake\Routing\Router::url(['controller' => 'Patients', 'action' => 'chiroAssessmentPlanVisitReport', $patient->id, $selectedVisit->id]) -->" target="_blank" class="export-link" escape=false>
							<!-- php: = $this->Html->image('../assets/img/pdf.png',['class' => 'export-action', 'style' => 'width: 30px; height: auto']) -->
...
export default function ElementElementPatientvisitChiroReports() {
