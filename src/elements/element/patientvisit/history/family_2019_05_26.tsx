...
<div class="row">
	<div class="borderBox light bordered col-md-12">
		<div class="borderBox-title tabbable-line">
			<div class="caption">
				<span class="caption-subject font-dark bold uppercase">Family History</span>
			</div>
							...
							<table class="table table-hover table-checkable order-column full-width slimDataTable">
								...
								<!-- php: $x = 1; foreach ($labTests as $value): -->
									...
									<tr class="odd gradeX">
										...
										<td class="left">
											<a data-toggle="modal" data-target="#editLabTestDialogue_<!-- php: = $value->id -->" href="javascript:" class="btn btn-default btn-xs">
												Edit
											</a>
											
											<!-- php: = $this->Form->postLink(__('Delete'), ['controller'=>'ManageLabs','action'=>'deleteLabTest',$value->id], ['confirm' => __('Are you sure you want to delete {0}?', $value->name), 'class' => 'btn btn-danger btn-xs']) -->
										</td>
									</tr>
									  ...
									  <div class="modal-dialog modal-dialog-centered" role="document">
										<div class="modal-content">
										  <div class="modal-header">
											<h4 class="modal-title" id="editInvestigationDialogueTitle">Edit Lab Test: <!-- php: = $value->name --></h4>
																	...
																	<div class="form-group row">
																		...
																		<div class="col-md-7">
																			<SearchableSelectField class="form-control input-height" name="investigation_id" id="investigation_id" required>
																				...
																				<!-- php: foreach($investigations as $selectOption) { -->
																					<option value="<!-- php: = $selectOption->id -->" <!-- php: = $selectOption->id == $value->investigation_id ? 'selected="selected"' : "" --> ><!-- php: = $selectOption->name --></option>
																				<!-- php: } -->
...
export default function ElementElementPatientvisitHistoryFamily20190526() {
