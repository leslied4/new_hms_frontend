...
<div class="row">
	<div class="col-md-12 col-sm-12">
		<div class="table-container">
												...
												<!-- php: = $this->Form->create($value, ['url' => ['controller' => 'History', 'action' => 'editPastDrug', $value->id], 'class' => 'form-horizontal']) -->
													<div class="form-body">
														...
														<div class="form-group row">
															...
															<div class="col-md-7">
																<input type="text" name="current_medication" data-required="1" value="<!-- php: = $value->current_medication -->" placeholder="Enter current medication" class="form-control input-height" required /> 
															</div>
														</div>
														...
														<div class="form-group row">
															...
															<div class="col-md-7">
																<input type="text" name="herbal_medication" data-required="1" value="<!-- php: = $value->herbal_medication -->" placeholder="Enter herbal medication" class="form-control input-height" required /> 
															</div>
														</div>
			...
			<p align="center">
				<a data-toggle="modal" data-target="#addPastDrugHistoryDialogue" href="javascript:" class="btn btn-primary btn-xs">
					Add Past Surgery
				</a>
			</p>
									...
									<!-- php: = $this->Form->create(null, ['url' => ['controller' => 'History', 'action' => 'addPastDrug', $patient->id], 'class' => 'form-horizontal']) -->
										<div class="form-body">		
											...
											<div class="form-group row">
												...
												<div class="col-md-7">
													<input type="text" name="current_medication" data-required="1" placeholder="Enter current medication" class="form-control input-height" required /> 
												</div>
											</div>
											...
											<div class="form-group row">
												...
												<div class="col-md-7">
													<input type="text" name="herbal_medication" data-required="1" placeholder="Enter herbal medication" class="form-control input-height" required /> 
												</div>
											</div>
...
export default function ElementElementPatientvisitHistoryPastdrughistory20190526() {
