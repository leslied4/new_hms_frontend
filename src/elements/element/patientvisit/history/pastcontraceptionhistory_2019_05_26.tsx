...
<div class="row">
	<div class="col-md-12 col-sm-12">
		<div class="table-container">
			...
			<p align="center">
				<a data-toggle="modal" data-target="#addPastContraceptionHistoryDialogue" href="javascript:" class="btn btn-primary btn-xs">
...
export default function ElementElementPatientvisitHistoryPastcontraceptionhistory20190526() {
