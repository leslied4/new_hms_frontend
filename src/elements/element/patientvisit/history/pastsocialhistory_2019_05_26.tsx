const rawHtml = `
<!-- php: $value = $patientHistorySocial; -->
...
<div class="row">
	...
	<div class="col-md-4 col-sm-12">
		...
		<div class="table-container">
			...
			<!-- php: if(!isset($value)) { -->
			<p align="left">
				<a data-toggle="modal" data-target="#addPastSocialHistoryDialogue" href="javascript:" class="btn btn-primary btn-xs">
					Add Social History
				</a>
			</p>
			...
			<!-- php: } else { -->
			<p align="left">
				<a data-toggle="modal" data-target="#editPastSocialHistoryDialogue_<!-- php: = $value->id -->" href="javascript:" class="btn btn-primary btn-xs">
...
export default function ElementElementPatientvisitHistoryPastsocialhistory20190526() {
