const rawHtml = `
<!-- php: $value = isset($patient->patient_history_gynaecologics) && sizeof($patient->patient_history_gynaecologics) > 0 ? $patient->patient_history_gynaecologics[0] : null; -->
...
export default function ElementElementPatientvisitHistoryPastgynaecologichistory() {
