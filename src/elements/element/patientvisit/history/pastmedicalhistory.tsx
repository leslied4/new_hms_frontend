const rawHtml = `
<!-- php: // initialize variables $patientHistoryIllnesses = $patient->patient_history_illnesses; $patientHistorySurgeries = $patient->patient_history_surgeries; $patientHistoryHaemotransfusions = $patient->patient_history_haemotransfusions; -->
<div class="row">
	<div class="col-md-6 col-sm-12">
		<div class="table-container">
			...
			<div style="float: right">
				...
				<p align="center">
					<a data-toggle="modal" data-target="#addPastSurgeryHistoryDialogue" style="margin-top: 12px" href="javascript:" class="btn btn-primary btn-xs">
						Add Past Surgery
					</a>
				</p>
	...
	<div class="col-md-6 col-sm-12">
		<div class="table-container">
			...
			<div style="float: right">
				<p align="center">
					<a data-toggle="modal" data-target="#addPastHaemotransfusionsHistoryDialogue" style="margin-top: 12px" href="javascript:" class="btn btn-primary btn-xs">
	...
	<div class="col-md-12 col-sm-12">
		<div class="table-container">
			...
			<div style="float: right">
				<p align="center">
					<a data-toggle="modal" data-target="#addPastIllnessHistoryDialogue" style="margin-top: 12px" href="javascript:" class="btn btn-primary btn-xs">
						Add Past Illness
					</a>
				</p>
										...
										<!-- php: = $this->Form->create(null, ['url' => ['controller' => 'History', 'action' => 'addPastIllness', $patient->id], 'class' => 'form-horizontal']) -->
											<div class="form-body">																		
												...
												<div class="form-group row">
													...
													<div class="col-md-7">
														<input type="text" name="duration" data-required="1" placeholder="Enter duration" class="form-control input-height" /> 
													</div>
												</div>
												...
												<!-- php: = $this->Form->create($value, ['url' => ['controller' => 'History', 'action' => 'editPastIllness', $value->id], 'class' => 'form-horizontal']) -->
													<div class="form-body">																		
														...
														<div class="form-group row">
															...
															<div class="col-md-7">
																<input type="text" name="duration" data-required="1" value="<!-- php: = $value->duration -->" placeholder="Enter duration" class="form-control input-height" /> 
															</div>
														</div>
...
export default function ElementElementPatientvisitHistoryPastmedicalhistory() {
