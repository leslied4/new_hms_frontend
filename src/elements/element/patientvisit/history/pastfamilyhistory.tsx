const rawHtml = `
<!-- php: $value = isset($patient->patient_history_families) && sizeof($patient->patient_history_families) > 0 ? $patient->patient_history_families[0] : null; -->
	...
	<div class="col-md-12 col-sm-12">
		<div class="table-container">
			...
			<div style="float: right">
				...
				<!-- php: if(!isset($value)) { -->
				<p align="left">
					<a data-toggle="modal" data-target="#addPastFamilyHistoryDialogue" style="margin-top: 12px" href="javascript:" class="btn btn-primary btn-xs">
						Add Family History
					</a>
				</p>
				...
				<!-- php: } else { -->
				<p align="left">
					<a data-toggle="modal" data-target="#editPastFamilyHistoryDialogue_<!-- php: = $value->id -->" style="margin-top: 12px" href="javascript:" class="btn btn-primary btn-xs">
...
export default function ElementElementPatientvisitHistoryPastfamilyhistory() {
