									...
									<div class="tab-content">
															  ...
															  <div class="modal-dialog modal-dialog-centered" role="document" style="max-width: 800px">
																<div class="modal-content">
																  <div class="modal-header">
																	<h4 class="modal-title" id="exampleModalLongTitle">Images for Lab: <!-- php: = $requestLabItem->id --></h4>
										...
										<div class="tab-pane request_medication_content" id="borderBox_request_medication">
											...
											<div class="form-body">
												...
												<div class="form-group row">
													<label class="control-label col-md-3">Drug Name / Form / Dosage
														<span class="required"> * </span>
													</label>
													<div class="col-md-5">
														<SearchableSelectField class="form-control input-height selectpicker show-menu-arrow show-tick" data-size="10" title="Select drug" data-required="1" name="drug_stock_id" id="drug_stock_id" data-live-search="true"  required>
															<!-- option value="">Select...</option -->
												...
												<div class="form-group row">
													<label class="control-label col-md-3">Medication Type
													</label>
													<div class="col-md-5">
												...
												<div class="form-group row">
													<label class="control-label col-md-3">Route Of Administration
														<span class="required"> * </span>
													</label>
													<div class="col-md-5">
														<SearchableSelectField class="form-control input-height selectpicker show-menu-arrow show-tick" data-size="5" data-required="1" data-live-search="true" class="form-control input-height" name="dosage_form_id" id="dosage_form_id" required>
												...
												<div class="form-group row">
													<label class="control-label col-md-3">Allergy
														
													</label>
													<div class="col-md-5">
														<input type="text" name="allergy" id="allergy" placeholder="" class="form-control input-height" /> </div>
												</div>
												<div class="form-group row">
													<label class="control-label col-md-3">Repeat Prescription
														<span class="required"> * </span>
													</label>
													<div class="col-md-5">
														<SearchableSelectField class="form-control input-height selectpicker show-menu-arrow show-tick" data-required="1" data-size="5" class="form-control input-height" name="repeat_prescription" id="repeat_prescription" required>
															<option value="">Select...</option>
												...
												<div class="form-group row">
													<label class="control-label col-md-3">Refill Date
													</label>
													<div class="col-md-5">
														<div class="input-group date form_date " data-date="" data-date-format="yyyy-mm-dd" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd">
															<input class="form-control input-height" placeholder="Refill Date" name = "refill_date" id = "refill_date" type="text" value="" >
												...
												<div class="form-group row">
													...
													<div class="col-md-5">
														<!-- php: // default to patient if no provider is found $billTo = $selectedVisit->has('patient_insurance_profile_policy') ? $selectedVisit->patient_insurance_profile_policy->insurance_profile_policy_id : -1; -->
														<SearchableSelectField class="form-control input-height selectpicker show-menu-arrow show-tick" data-required="1" data-size="5" data-live-search="true" class="form-control input-height" name="bill_to_id" id="bill_to_id" required >
															<option value="">Select Bill To</option>
															<option <!-- php: = $billTo == -1 ? 'selected' : '' --> value="-1">Patient</option>
															<!-- php: foreach($providers as $provider) { -->
...
export default function ElementElementPatientvisitRequestservicesCore() {
