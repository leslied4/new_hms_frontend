				...
				<div class="row" id="page-content">
					...
					<div class="newNotBody col-12 p-3">
						...
						<div class="accordion mb-5" id="clinical_encounter_accordions">
							...
							<!--on direct questioning accordion-->
							<div class="accordionDiv mb-3  mx-3 ">
								<div id="odqHeading" class="accordion-header bold " data-toggle="collapse" data-target="#health_concern" aria-expanded="true" aria-controls="health_concern">
									Health Concerns
								</div>

								<div id="health_concern" class="collapse" aria-labelledby="odqHeading" data-parent="#clinical_encounter_accordions">
									<div class="card-body">
										<div class="row">

											<div class="borderBox light bordered col-md-12 d-flex">
												<div class="borderBox-title tabbable-line col-md-6 mr-4" id="">
													<form class='healthconcern_form' id="healthconcern_form">
														<div class="form-body" id="healthconcern_formbody">

															<div class="form-group row">
																<label class="control-label col-md-5">Concern

																</label>
																<div class="col-md-7">
																	<input type="text" name="name" data-required="0" placeholder="" class="form-control input-height" />
																</div>
															</div>

															<div class="form-group row">
																<label class="control-label col-md-5">Where is it Location?

																</label>
																<div class="col-md-7">
																	<input type="text" name="location" data-required="0" placeholder="" class="form-control input-height" />
																</div>
															</div>

															<div class="form-group row">
																<label class="control-label col-md-5">Where Does it Radiate To?

																</label>
																<div class="col-md-7">
																	<input type="text" name="radiate" data-required="0" placeholder="" class="form-control input-height" />
																</div>
															</div>
															<div class="form-group row">
																<label class="control-label col-md-5">What makes it better?

																</label>
																<div class="col-md-7">
																	<input type="text" name="what_better" data-required="0" placeholder="" class="form-control input-height" />
																</div>
															</div>
															<div class="form-group row">
																<label class="control-label col-md-5">What makes it worse?

																</label>
																<div class="col-md-7">
																	<input type="text" name="what_worse" data-required="0" placeholder="" class="form-control input-height" />
																</div>
															</div>
															<div class="form-group row">
																<label class="control-label col-md-5">What Time of day does it normally occur?

																</label>
																<div class="col-md-7">
																	<SearchableSelectField class="form-control input-height selectpicker" name="time_of_day" multiple>
															...
															<div class="form-group row">
																<label class="control-label col-md-5">When did it first begin?

																</label>
																<div class="col-md-7">
																	<input type="date" name="when" data-required="0" placeholder="" class="form-control input-height" />
																</div>
															</div>
															<div class="form-group row">
																<label class="control-label col-md-5">What Do you think is the cause of this body signal?

																</label>
																<div class="col-md-7">
																	<input type="text" name="cause" data-required="0" placeholder="" class="form-control input-height" />
																</div>
															</div>
														</div>
													</form> 
												</div>
												<div class="borderBox-title tabbable-line col-md-6" id="">

													<canvas id="canvas" width="500" height="500"></canvas>

													<!-- Buttons to Add Shapes -->
													<!-- <button onclick="addRectangle()">Add Rectangle</button> -->
													<button onclick="addCircle()" class="btn btn-danger btn-xs">+ Add Pain Location</button>

													<form id="imageForm" action="/submit" method="POST" enctype="multipart/form-data" style="display: none;"></form>
							...
							<!--on direct questioning accordion-->
							<div class="accordionDiv mb-3  mx-3 ">
								<div id="odqHeading" class="accordion-header bold " data-toggle="collapse" data-target="#biostructural_exam" aria-expanded="true" aria-controls="biostructural_exam">
									Life Enhancing Bio-structural Exam
								</div>

								<div id="biostructural_exam" class="collapse" aria-labelledby="odqHeading" data-parent="#clinical_encounter_accordions">
									<div class="card-body">
										<div class="row">

											<div class="borderBox light bordered col-md-12 d-flex">
												<form class='bioexam_form col-md-12' id="bioexam_form">
													<div class="borderBox-title tabbable-line col-md-12 mr-4" id="">
														<div class="form-body row flex-column col-md-12" id="bioexam_formbody">
															...
															<div class="form-group row">
																...
																<div class="col-md-2">
																	<input type="text" name="kilos_lt" data-required="0" placeholder="" class="form-control input-height" />
																</div>
																<label class="control-label col-md-1">RT:
																</label>
																<div class="col-md-2">
																	<input type="text" name="kilos_rt" data-required="0" placeholder="" class="form-control input-height" />
																</div>
																<label class="control-label col-md-1">=
																</label>
																<div class="col-md-3">
																	<input type="text" name="kilos_eq" data-required="0" placeholder="" class="form-control input-height" />
																</div>
															</div>
															<div class="form-group row">
																...
																<div class="col-md-2">
																	<input type="text" name="sht_lt" data-required="0" placeholder="" class="form-control input-height" />
																</div>
																<label class="control-label col-md-1">RT:
																</label>
																<div class="col-md-2">
																	<input type="text" name="sht_rt" data-required="0" placeholder="" class="form-control input-height" />
																</div>
															</div>
															<div class="form-group row justify-content-center mt-3">
																<h5 class="control-label col-md-5 font-weight-bold">L/S ROM (Lumbar Spine Range of Motion)
																</h5>
															</div>
															...
															<div class="form-group row">
																...
																<div class="col-md-3">
																	<input type="text" name="lsrom_flex" data-required="0" placeholder="" class="form-control input-height" />
																</div>
																...
																<div class="col-md-3">
																	<input type="text" name="lsrom_ext" data-required="0" placeholder="" class="form-control input-height" />
																</div>
															</div>
															<div class="form-group row">
																...
																<div class="col-md-3">
																	<input type="text" name="lsrom_lt_flex" data-required="0" placeholder="" class="form-control input-height" />
																</div>
																...
																<div class="col-md-3">
																	<input type="text" name="lsrom_rt_flex" data-required="0" placeholder="" class="form-control input-height" />
																</div>
															</div>
															<div class="form-group row">
																...
																<div class="col-md-3">
																	<input type="text" name="lsrom_lt_rot" data-required="0" placeholder="" class="form-control input-height" />
																</div>
																...
																<div class="col-md-3">
																	<input type="text" name="lsrom_rt_rot" data-required="0" placeholder="" class="form-control input-height" />
																</div>
															</div>

															<div class="form-group row justify-content-center mt-3">
																<h5 class="control-label col-md-5 font-weight-bold">MEASURE OF MOBILITY
																</h5>
															</div>
															...
															<div class="form-group row">
																...
																<div class="col-md-9">
																	<input type="text" name="ls_mm" data-required="0" placeholder="" class="form-control input-height" />
																</div>
																<label class="control-label col-md-3">T/S MM:
																</label>
																<div class="col-md-9">
																	<input type="text" name="ts_mm" data-required="0" placeholder="" class="form-control input-height" />
																</div>
																<label class="control-label col-md-3">C/S MM:
																</label>
																<div class="col-md-9">
																	<input type="text" name="cs_mm" data-required="0" placeholder="" class="form-control input-height" />
																</div>
															</div>

															<div class="form-group row justify-content-center mt-3">
																<h5 class="control-label col-md-5 font-weight-bold">HIGH SHOULDER:
																</h5>
															</div>
															...
															<div class="form-group row">
																...
																<div class="col-md-9">
																	<input type="text" name="high_shoulder_lt" data-required="0" placeholder="" class="form-control input-height" />
																</div>
																<label class="control-label col-md-3">RT:
																</label>
																<div class="col-md-9">
																	<input type="text" name="high_shoulder_rt" data-required="0" placeholder="" class="form-control input-height" />
																</div>
																<label class="control-label col-md-3">HT:
																</label>
																<div class="col-md-9">
																	<input type="text" name="high_shoulder_ht" data-required="0" placeholder="" class="form-control input-height" />
																</div>
															</div>
															...
															<div class="form-group row">
																...
																<div class="col-md-3">
																	<input type="text" name="csrom_flex" data-required="0" placeholder="" class="form-control input-height" />
																</div>
																<label class="control-label col-md-2">EXT:
																</label>
																<label class="control-label col-md-1">P!:
																...
																<div class="col-md-3">
																	<input type="text" name="csrom_ext" data-required="0" placeholder="" class="form-control input-height" />
																</div>
															</div>
															<div class="form-group row">
																<label class="control-label col-md-2">LT FLEX:
																...
																<div class="col-md-3">
																	<input type="text" name="csrom_lt_flex" data-required="0" placeholder="" class="form-control input-height" />
																</div>
																<label class="control-label col-md-2">RT FLEX:
																</label>
																<label class="control-label col-md-1">P!
																...
																<div class="col-md-3">
																	<input type="text" name="csrom_rt_flex" data-required="0" placeholder="" class="form-control input-height" />
																</div>
															</div>
															<div class="form-group row">
																<label class="control-label col-md-2">LT ROT:
																...
																<div class="col-md-3">
																	<input type="text" name="csrom_lt_rot" data-required="0" placeholder="" class="form-control input-height" />
																</div>
																<label class="control-label col-md-2">RT ROT:
																</label>
																<label class="control-label col-md-1">P!:
																...
																<div class="col-md-3">
																	<input type="text" name="csrom_rt_rot" data-required="0" placeholder="" class="form-control input-height" />
																</div>
															</div>

															<div class="form-group row justify-content-center mt-5">
																<h5 class="control-label col-md-2 font-weight-bold">PELVIC MECHANICS
																</h5>
															</div>
															...
															<div class="form-group row">
																...
																<div class="col-md-9">
																	<input type="text" name="pelvic_shift" data-required="0" placeholder="" class="form-control input-height" />
																</div>
																<label class="control-label col-md-3">PELVIC ROTATION
																</label>
																<div class="col-md-9">
																	<input type="text" name="pelvic_rotation" data-required="0" placeholder="" class="form-control input-height" />
																</div>
															</div>

															<div class="form-group row justify-content-center mt-3">
																<h5 class="control-label col-md-2 font-weight-bold">THORACIC MECHANICS
																</h5>
															</div>
															...
															<div class="form-group row">
																...
																<div class="col-md-9">
																	<input type="text" name="thoracic_shift" data-required="0" placeholder="" class="form-control input-height" />
																</div>
																<label class="control-label col-md-3">THORACIC FLEXION
																</label>
																<div class="col-md-9">
																	<input type="text" name="thoracic_flexion" data-required="0" placeholder="" class="form-control input-height" />
																</div>
																<label class="control-label col-md-3">THORACIC ROTATION
																</label>
																<div class="col-md-9">
																	<input type="text" name="thoracic_rotation" data-required="0" placeholder="" class="form-control input-height" />
																</div>
															</div>

															<div class="form-group row justify-content-center mt-3">
																<h5 class="control-label col-md-2 font-weight-bold">PELVIS MECHANICS
																</h5>
															</div>
															...
															<div class="form-group row">
																...
																<div class="col-md-9">
																	<input type="text" name="center_sacrum" data-required="0" placeholder="" class="form-control input-height" />
																</div>
																<label class="control-label col-md-3">CENTER OF FEMORAL HEAD
																</label>
																<div class="col-md-9">
																	<input type="text" name="center_femoral_head" data-required="0" placeholder="" class="form-control input-height" />
																</div>
																<label class="control-label col-md-3">CENTER OF ROTATION
																</label>
																<div class="col-md-9">
																	<input type="text" name="center_rotation" data-required="0" placeholder="" class="form-control input-height" />
																</div>
															</div>
															<div class="form-group row mt-3">
																...
																<div class="col-md-9">
																	<input type="text" name="femoral_head_translation" data-required="0" placeholder="" class="form-control input-height" />
																</div>
															</div>
...
export default function ElementElementPatientvisitSymptomChiroSymptoms() {
