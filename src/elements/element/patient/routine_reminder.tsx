...
<script>
    ...
    function getRoutineReminders() {
        ...
        $.ajax({
        url: '<!-- php: = $this->Url->build(['controller' => 'Patients', 'action' => 'getRoutineReminders', '1']) -->',
        type: 'GET',
        success: function(res){
            ...
            res.forEach(ele => {
                ...
                <tr>
                    ...
                    <td>\${ele.patient.first_name} \${ele.patient.last_name}</td>
                    <td>\${ele.patient.phone || ''}</td>
                    <td>\${ele.patient.email || ''}</td>
                    <td>\${ele.subject}</td>
...
export default function ElementElementPatientRoutineReminder() {
