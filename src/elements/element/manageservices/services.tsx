		...
		<div class="borderBox-body">
			<div class="tab-content">
				<div class="tab-pane " id="services_add">
					...
					<!-- php: = $this->Form->create(null, ['url' => ['controller' => 'ManageServices', 'action' => 'addService']]); -->
								...
								<!-- php: $x = 1; foreach ($services as $value): -->
									...
									<tr class="odd gradeX">
										...
										<td class="left">
											...
											<!-- php: = $this->Form->postLink(__('Delete'), ['controller'=>'ManageServices','action'=>'deleteService',$value->id], ['confirm' => __('Are you sure you want to delete {0}?', $value->name), 'class' => 'btn ' . Cake\Core\Configure::read('Classes.Dele... -->
										</td>
									</tr>
									  ...
									  <div class="modal-dialog modal-dialog-centered" role="document">
										<div class="modal-content">
										  <div class="modal-header">
											<h4 class="modal-title" id="editServiceDialogueTitle">Edit Service: <!-- php: = $value->name --></h4>
												...
												<div class="col-md-12 col-sm-12">
													<div class="card card-box">
														...
														<div class="card-body" id="bar-parent">
															<!-- php: = $this->Form->create($value, ['url' => ['controller' => 'ManageServices', 'action' => 'editService', $value->id], 'class' => 'form-horizontal']) -->
																<div class="form-body">
																	<div class="form-group row">
...
export default function ElementElementManageservicesServices() {
