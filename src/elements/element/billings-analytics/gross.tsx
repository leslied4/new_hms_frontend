    ...
    <div class="borderBox light bordered col-md-12">
        ...
        <div class="col-md-2 d-flex justify-content-start pl-0">
            ...
            <div class="row d-flex justify-content-between">
                ...
                <div class="col-md-3 card p-3">
                <small class="darkorange mb-0 pb-0">WRITE OFFS</small>
...
<script>
     function grossTab(filter){
			$.ajax({
				url: '<!-- php: = $this->Url->build(['controller' => 'Billings', 'action' => 'grossTab']) -->/'+filter,
				type: 'GET',
				cache: false,
                beforeSend: function(){
				...
				success: function(res){
					// alert("you sabi cook");
					console.log(res);
                    grossgraphs(res.charges, res.gross_collections, res.write_offs, res.net_collections);
        ...
        function grossgraphs(charges, gross_collections, write_offs, net_collections){
        var charges_data = [
            {
                type: "indicator",
                mode: "number+delta",
        ...
        var write_offs_data = [
            {
                type: "indicator",
                mode: "number+delta",
                value: Number(write_offs.recent),
                number: { prefix: "" },
                delta: { position: "top", reference: Number(write_offs.previous) },
                domain: { x: [0, 1], y: [0, 1] }
            }
        ];
        ...
        Plotly.newPlot('gros-wr', write_offs_data, layout);
...
export default function ElementElementBillingsAnalyticsGross() {
