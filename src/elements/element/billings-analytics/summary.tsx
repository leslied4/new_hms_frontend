...
<div class="row">
    <div class="borderBox light bordered col-md-12">
        ...
        <div class="container">
            ...
            <button onclick="getBillingsSummary()" style="box-shadow:none!important" class="btn text-primary bg-white"><i class="fa fa-rotate-right"></i></button></h4>
            </h4>
            <div class="row d-flex justify-content-between">
                ...
                <div class="col card p-3">
                    <small class="text-primary mb-0 pb-0">TOTAL INVOICE A/R</small>
                    <h3 id="summary-total-invoice" style="margin-top:0px!important;margin-bottom:0px!important;" class="mt-0"></h3>
                </div>
                
                <div class="col card p-3">
                    <small class="text-danger mb-0 pb-0">% INVOICE A/R</small>
                ...
                <div class="col card p-3">
                    <small class="text-warning mb-0 pb-0">Paid Invoice</small>
                    <h3 id="paid_invoices" style="margin-top:0px!important;margin-bottom:0px!important;" class="my-0 pb-0"></h3>
                    <!-- <small class="text-secondary mt-0">1-15 days</small> -->
                </div>
        ...
        <div class="container mt-4 py-3 px-0">
            <h4>Invoices Accounts Receivable Aging 0-90+ days</h4>
        ...
        <div class="container mt-4 py-3 px-0">
            <h4>Invoice Payment Methods 0-90+ days</h4>
            <div class="container-fluid card p-3">
...
function getBillingsSummary() {
  $.ajax({
        url: '<!-- php: = $this->Url->build(['controller' => 'Billings', 'action' => 'billingsSummary']) -->',
        type: 'GET',
        cache: false,
        beforeSend: function(){
            ...
            billingsSummaryIndicators({'recent':0, 'previous': 0},{'recent':0, 'previous': 0},{'recent':0, 'previous': 0},{'recent':0, 'previous': 0}, {'recent':0, 'previous': 0}, {'recent':0, 'previous': 0});
        },
        success: function(res){
            // alert("you sabi cook");
            console.log(res);
                billingsSummaryIndicators(res.patient_visits, res.gross_collections, res.net_collections, res.account_receivables, res.account_receivables_rate, res.paid);
...
function billingsSummaryIndicators(patient_visits, gross_collections, net_collections, total_invoice, total_invoice_over, paid_invoice){
...
var paid_data = [
    {
        type: "indicator",
        mode: "number+delta",
        value: paid_invoice.recent,
        number: { prefix: "" },
        delta: { position: "top", reference: paid_invoice.previous },
        domain: { x: [0, 1], y: [0, 1] }
    }
];
var layout = {
...
Plotly.newPlot('paid_invoices', paid_data, layout);
...
function getProcedures(data){
    ...
    for(const d in data){
        ...
        $("#procedures-container").append('<div class="container mt-4 py-3 px-0"><h4>Top 10 '+d+' Procedures 0-90+ days</h4><div class="container-fluid card p-3"><div id="'+d.toLowerCase()+'-chart-container" style="height: 400px;width:1100px; min-width: 100%;"></div></div></div');
...
export default function ElementElementBillingsAnalyticsSummary() {
