		...
		<div class="borderBox-body">
			<div class="tab-content">
				<div class="tab-pane " id="stockitems_add">
					...
					<!-- php: = $this->Form->create($stock, ['url' => ['controller' => 'InventoryOtherservices', 'action' => 'addStock']]); -->
						...
						<div class="form-group row">
							...
							<div class="col-md-5">
								<SearchableSelectField class="form-control input-height" name="service_id" id="service_id" required>
									<option value="">Select...</option>
									
									<!-- php: foreach($services as $selectOption) { -->
										<option value="<!-- php: = $selectOption->id -->"><!-- php: = $selectOption->service_name --></option>
									<!-- php: } -->
						...
						<div class="form-group row">
							...
							<div class="col-md-5">
								<input type="text" step="1" min="1" name="procedure_name" id="procedure_name" data-required="1" placeholder="Enter procedure_name" class="form-control input-height" required /> 
							</div>
						</div>
						...
						<div class="form-group row">
							...
							<div class="col-md-5">							
								<div class="input-group date form_date " data-date="" data-date-format="yyyy-mm-dd" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd">
									<input class="form-control input-height" placeholder="End Date" name="begin_date" id="begin_date" type="text" value="" readonly >
						...
						<div class="card-body ">
						  <div class="table-scrollable">
							<table class="table table-hover table-checkable order-column full-width slimDataTable">
								...
								<tbody>
								<!-- php: $x = 1; foreach ($stocks as $value): -->								
									<tr class="odd gradeX">
									<td class="left"><!-- php: =$x --></td>
										<td class="left"><!-- php: =$value->service->service_name --></td>
...
export default function ElementElementInventoryOtherservicesStocks() {
